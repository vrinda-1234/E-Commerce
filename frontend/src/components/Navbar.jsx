          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {user && (
              ...
              >
                ...
                <span className="absolute -top-2 -left-2 bg-emerald-500 text-white rounded-full px-2 py-0.5 text-x5 group-hover:bg-emerald-400 transition duration-300 ease-in-out ">
                  3
                </span>
              </Link>
            )}
            ...
            {user ? (
              <button className="bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 rounded-md flex items-center transition duration-300 ease-in-out">
                <LogOut size={18} />
                <span className="hidden sm:inline m1-2">Log Out</span>
              </button>
            ) : (
              <>
                <Link
